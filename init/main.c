...
// REMOVE DM-VERITY2  FORCED CHECK  HACK
  //     char word1[] = "skip_initramfs";
    ...
    char word11[] = "androidboot.skuid=";
    char word22[] = "none=";
    char word111[] = "androidboot.fihmode=0";
    char word222[] = "androidboot.fihmode=1";
...
// REMOVE DM-VERITY2  FORCED CHECK  HACK
    ...
    /* finding length of word */
           ...
           for (i = 0, j = 0; command_line[i] != '\0' && word1[j] != '\0'; i++)
              {
                if (command_line[i] == word1[j])
                  {
                         j++;
                  }              
                  else
...
{  
          ...
          if ((pch) && (i>6))
          {
             ...
             i=12;
 //            strcat (strresult, command_line);
             strcat (command_line, strnokia );
//			 strcpy (command_line, strresult );
           }
          if ((pch) && (i<7))
         {
