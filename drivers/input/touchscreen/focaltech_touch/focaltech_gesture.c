...
#define  KEY_GESTURE_UP                   66
#define  KEY_GESTURE_DOWN                     64
#define  KEY_GESTURE_LEFT                       63
#define  KEY_GESTURE_RIGHT                   65
...
extern int gdouble_tap_enable;//snow
...
FTS_DEBUG("envp[0]: %s", envp[0]);
FTS_DEBUG("gdouble_tap_enable %d", gdouble_tap_enable);
FTS_DEBUG("letter_c_enable %d", letter_c_enable);
FTS_DEBUG("swipe_up_enable %d", swipe_up_enable);
FTS_DEBUG("swipe_down_enable %d", swipe_down_enable);
FTS_DEBUG("swipe_up_enable %d", swipe_left_enable);
FTS_DEBUG("swipe_right_enable %d", swipe_right_enable);

    /* report event key */
	
//	   if (gesture ==  KEY_WAKEUP)
    if ((gesture == KEY_WAKEUP) && (gdouble_tap_enable))
    {
    ...
    if ((gesture ==  KEY_GESTURE_UP) && (swipe_up_enable))
   {
        input_report_key(input_dev, gesture, 1);
        input_sync(input_dev);
        input_report_key(input_dev, gesture, 0);
    ...
    if ((gesture ==  KEY_GESTURE_DOWN) && (swipe_down_enable))
   {
        input_report_key(input_dev, gesture, 1);
        input_sync(input_dev);
        input_report_key(input_dev, gesture, 0);
    ...
    if ((gesture ==  KEY_GESTURE_LEFT) && (swipe_left_enable))
   {
        input_report_key(input_dev, gesture, 1);
        input_sync(input_dev);
        input_report_key(input_dev, gesture, 0);
    ...
    if ((gesture ==  KEY_GESTURE_RIGHT) && (swipe_right_enable))
   {
        input_report_key(input_dev, gesture, 1);
        input_sync(input_dev);
        input_report_key(input_dev, gesture, 0);
    ...
    if ((gesture ==  KEY_GESTURE_C) && (letter_c_enable))
   {
        input_report_key(input_dev, gesture, 1);
        input_sync(input_dev);
        input_report_key(input_dev, gesture, 0);
