...
{
#include "YJ_A305_YD_C00_2017-12-22.i"
};
#endif
...
//	(strstr(saved_command_line, "androidboot.device=HD1"))||(strstr(saved_command_line, "androidboot.device=DRG"))) return err;
...
int himax_chip_common_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    struct himax_ts_data *ts;
    struct himax_i2c_platform_data *pdata;
    if (!strstr(saved_command_line, "androidboot.device=HD1"))  goto err_check_functionality_failed;
