...
#define FREE_ALL                _IOW(MA_IOC_MAGIC, 49, unsigned int)
//#define TAP_VIBRATE   _IO(MA_IOC_MAGIC, 60)
//#define SET_IC_INFO/*SET_IC_INFO*/               _IO(MA_IOC_MAGIC, 52) //zhangkaiyuan@wind-mobi.com 20171214
//#define MA_POWER_ON             _IO(MA_IOC_MAGIC, 53) //zhangkaiyuan@wind-mobi.com 20180208
