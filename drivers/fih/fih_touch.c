	...
	size_t count, loff_t *ppos)
{
	...
	int ret = 0;	//SW4-HL-Touch-DoubleTapOptionAllowedModifyOnlyWhenLcmIsOn-00+_20170927
	...
	if (touch_cb.touch_double_tap_write != NULL)
	{
		...
		ret = touch_cb.touch_double_tap_write(double_tap);	//SW4-HL-Touch-DoubleTapOptionAllowedModifyOnlyWhenLcmIsOn-00*_20170927
		if (ret)
			return -EPERM;
	}
	return count;
